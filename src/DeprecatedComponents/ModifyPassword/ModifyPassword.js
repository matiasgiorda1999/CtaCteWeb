...
const ModifyPassword = ({ setFunctionality }) => {
  ...
  const validateOldPass = () => {
    if (
      ...
      parseJwt(sessionStorage.getItem("token")).user.contrasena
    ) {
      ...
      axios
        ...
        .then((res) => {
          ...
          if (res.data.msj === "Registro usuario modificado exitosamente") {
            ...
            axios
              .post(`${PORT()}/login`, {
                email: parseJwt(sessionStorage.getItem("token")).user.email,
                password: newPass,
              })
              .then((res) => {
    ...
    <div className="container">
      ...
      <div className="form-group row">
        <label
          ...
          className="col-md-2 offset-md-3 col-form-label"
        >
          Contraseña anterior
        </label>
      ...
      <div className="form-group row">
        <div className="col-md-3 offset-md-5">
          <ul style={{ listStyle: "none" }}>
            <li>
              <FontAwesomeIcon
                icon={errLengthPass ? faTimes : faCheck}
            ...
            <li>
              <FontAwesomeIcon
                icon={errEspCharPass ? faTimes : faCheck}
            ...
            <li>
              <FontAwesomeIcon
                icon={errNumPass ? faTimes : faCheck}
      ...
      <div className="form-group row">
        <div className="col-md-3 offset-md-5">
          <ul style={{ listStyle: "none" }}>
            <li>
              <FontAwesomeIcon
                icon={errEqualsPass ? faTimes : faCheck}
      ...
      <div className="row">
        <button
          className="btn btnCancel col-md-2 offset-md-5"
          onClick={() => {
            setFunctionality("CtaCteQuery");
          }}
        >
        ...
        <button
          className="btn btnAccept col-md-2 offset-md-1"
